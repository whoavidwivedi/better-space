export const USERPIC_NAMES: string[] = [
  "01", "Afterclap-1", "Afterclap-2", "Afterclap-3", "Afterclap-4", "Afterclap-5",
  "Afterclap-6", "Afterclap-7", "Afterclap-8", "Afterclap-9", "Afterclap",
  "Cranks-1", "Cranks-2", "Cranks",
  "Delivery boy-1", "Delivery boy-2", "Delivery boy-3", "Delivery boy-4", "Delivery boy-5", "Delivery boy",
  "E-commerce-1", "E-commerce-2", "E-commerce",
  "Funny Bunny-1", "Funny Bunny-2", "Funny Bunny-3", "Funny Bunny-4", "Funny Bunny-5",
  "Funny Bunny-6", "Funny Bunny-7", "Funny Bunny-8", "Funny Bunny",
  "Guacamole-1", "Guacamole-2", "Guacamole-3", "Guacamole",
  "Juicy-1", "Juicy",
  "No comments 3", "No comments 4", "No comments 5", "No comments 6", "No comments 7", "No comments 8", "No comments 9",
  "No Comments-1", "No Comments-2", "No Comments-3", "No Comments",
  "No gravity-1", "No gravity-2", "No gravity-3", "No gravity",
  "OSLO-1", "OSLO-10", "OSLO-11", "OSLO-12", "OSLO-13", "OSLO-14", "OSLO-2", "OSLO-3", "OSLO-4", "OSLO-5", "OSLO-6", "OSLO-7", "OSLO-8", "OSLO-9", "OSLO",
  "Teamwork-1", "Teamwork-2", "Teamwork-3", "Teamwork-4", "Teamwork-5", "Teamwork-6", "Teamwork-7", "Teamwork-8", "Teamwork",
  "Upstream-1", "Upstream-10", "Upstream-11", "Upstream-12", "Upstream-13", "Upstream-14", "Upstream-15", "Upstream-16", "Upstream-17", "Upstream-2", "Upstream-3", "Upstream-4", "Upstream-5", "Upstream-6", "Upstream-7", "Upstream-8", "Upstream-9", "Upstream",
]
...
export const CHARACTER_COLLECTIONS: CharacterCollection[] = [
  ...
  },
  {
    ...
    characters: USERPIC_NAMES.filter(
      (n) => n.startsWith("Cranks") || n.startsWith("No gravity") || n.startsWith("No comments") || n.startsWith("No Comments")
    ),
  },
]
