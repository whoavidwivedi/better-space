...
import { Shuffle as RiShuffleLine, Mic as RiMicLine } from "lucide-react"
          ...
          <div className="space-y-2.5">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                className="h-10 rounded-xl font-mono text-xs font-bold tracking-wider text-foreground uppercase"
